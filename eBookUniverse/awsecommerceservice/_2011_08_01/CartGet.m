...
+(PicoClassSchema *)getClassMetaData {
    PicoClassSchema *cs = [[PicoClassSchema alloc] initWithXmlName:@"CartGet" nsUri:@"http://webservices.amazon.com/AWSECommerceService/2011-08-01"];
    //[cs autorelease];
    return cs;
}
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    map[@"xmlEscaping"] = ps;
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"Shared" propertyName:@"shared" type:PICO_TYPE_OBJECT clazz:[CartGetRequest class]];
    map[@"shared"] = ps;
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT_ARRAY xmlName:@"Request" propertyName:@"request" type:PICO_TYPE_OBJECT clazz:[CartGetRequest class]];
    map[@"request"] = ps;
